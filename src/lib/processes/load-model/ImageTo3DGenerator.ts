 ...
 * Defaults to /generation_all for textured results, automatically falling
 * back to /shape_generation if the textured attempt fails for any reason.
 *
...
export class ImageTo3DGenerator {
   ...
   *
   * If the textured endpoint fails for any reason, this automatically
   * retries once against the lighter/faster untextured endpoint rather
